...
class RentAdapter extends RecyclerView.Adapter<ansarker.github.io.houserent.RentAdapter.ViewHolder> {
...
//            ivHouse.setImageResource(R.drawable.signboard_for_rent);
    ...
    @NonNull
    @Override
    public ansarker.github.io.houserent.RentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ansarker.github.io.houserent.RentAdapter.ViewHolder viewHolder, int i) {
