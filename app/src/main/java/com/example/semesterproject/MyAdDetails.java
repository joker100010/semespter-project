...
public class MyAdDetails extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater inflater = new MenuInflater(ansarker.github.io.houserent.MyAdDetails.this);
        ...
        if (item.getItemId() == R.id.menuEditPost) {
            rentDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    new AlertDialog.Builder(ansarker.github.io.houserent.MyAdDetails.this).setTitle("Success").setMessage("Updated successfully!").show();
                    startActivity(new Intent(ansarker.github.io.houserent.MyAdDetails.this, MyPosts.class));
                }
            ...
            new AlertDialog.Builder(ansarker.github.io.houserent.MyAdDetails.this)
                    .setTitle("Warning")
