...
public class MyPosts extends AppCompatActivity implements  ansarker.github.io.houserent.RentAdapter.ItemClicked {
        ...
        rentDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot rentSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if (rents.getUserName().equals(ansarker.github.io.houserent.Availablity.currentUser.getUserName())) {
                ...
                layoutManager = new LinearLayoutManager(ansarker.github.io.houserent.MyPosts.this);
                houseAdapter = new ansarker.github.io.houserent.RentAdapter(ansarker.github.io.houserent.MyPosts.this, rent);
    ...
    public void onItemClicked(final int index) {
        userDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            Intent myAdDetailsIntent = new Intent(ansarker.github.io.houserent.MyPosts.this, ansarker.github.io.houserent.MyAdDetails.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menuClearPost) {
            new AlertDialog.Builder(ansarker.github.io.houserent.MyPosts.this)
                    .setTitle("Title")
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Query rentsQuery = rentDatabase.orderByChild("userName").equalTo(ansarker.github.io.houserent.Availablity.currentUser.getUserName());
