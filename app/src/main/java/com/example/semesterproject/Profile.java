    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        tvProfileGender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(ansarker.github.io.houserent.Profile.this);
        ...
        tvProfileDateOfBirth.setOnClickListener(new View.OnClickListener() {
           @Override
            public void onClick(View v) {
                new DatePickerDialog(ansarker.github.io.houserent.Profile.this, date, myCalendar
            ...
            public void onClick(View v) {
                userDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        new AlertDialog.Builder(ansarker.github.io.houserent.Profile.this)
                                .setTitle("Success")
