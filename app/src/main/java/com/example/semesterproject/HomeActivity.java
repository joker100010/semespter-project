...
public class HomeActivity extends AppCompatActivity implements RentAdapter.ItemClicked, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rentDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                layoutManager = new LinearLayoutManager(ansarker.github.io.houserent.HomeActivity.this);
                houseAdapter = new RentAdapter(ansarker.github.io.houserent.HomeActivity.this, rent);
    ...
    public void onItemClicked(final int index) {
        userDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            Intent homeDetailsIntent = new Intent(ansarker.github.io.houserent.HomeActivity.this, HomeDetailsActivity.class);
