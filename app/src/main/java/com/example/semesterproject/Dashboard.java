...
//        tvTotalUsers = findViewById(R.id.tvTotalUsers);
        ...
        try {
            if (ansarker.github.io.houserent.Availablity.currentUser.getRole().equals("Renter")) {
            ...
            } else if (ansarker.github.io.houserent.Availablity.currentUser.getRole().equals("Owner")) {
                NavigationView navigationView = findViewById(R.id.nav_view);
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(ansarker.github.io.houserent.Dashboard.this);
            alert.setTitle("Welcome");
            alert.setMessage("" + ansarker.github.io.houserent.Availablity.currentUser.getName());
            alert.show();
            tvWelcomeUser.setText("Welcome\n" + ansarker.github.io.houserent.Availablity.currentUser.getEmail());
            ...
            tvHeaderUserName.setText(ansarker.github.io.houserent.Availablity.currentUser.getName());
            tvHeaderEmail.setText(ansarker.github.io.houserent.Availablity.currentUser.getEmail());
        } catch (NullPointerException ignored) {
            startActivity(new Intent(ansarker.github.io.houserent.Dashboard.this, ansarker.github.io.houserent.MainActivity.class));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuAbout) {
            AlertDialog aboutme = new AlertDialog.Builder(ansarker.github.io.houserent.Dashboard.this)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.itemHome) {
            Intent homeIntent = new Intent(ansarker.github.io.houserent.Dashboard.this, ansarker.github.io.houserent.HomeActivity.class);
            startActivity(homeIntent);
        } else if(id == R.id.itemAddRent) {
            Intent postAdIntent = new Intent(ansarker.github.io.houserent.Dashboard.this, PostAdActivity.class);
            startActivity(postAdIntent);
        } else if (id == R.id.itemMyPosts) {
            Intent myPostIntent = new Intent(ansarker.github.io.houserent.Dashboard.this, ansarker.github.io.houserent.MyPosts.class);
            startActivity(myPostIntent);
        } else if (id == R.id.itemProfile) {
            Intent profileIntent = new Intent(ansarker.github.io.houserent.Dashboard.this, ansarker.github.io.houserent.Profile.class);
            startActivity(profileIntent);
        } else if (id == R.id.itemSignOut) {
            super.onBackPressed();
            Intent loginIntent = new Intent(getApplicationContext(), ansarker.github.io.houserent.MainActivity.class);
